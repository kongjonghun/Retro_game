...
# Enemy 불러오기
enemy = pygame.image.load("C:\\Users\\rhd05\\OneDrive\\바탕 화면\\파이썬 프로젝트\\pygame_basic\\enemy.png")
...
while running:
    ...
    character_x_pos += to_x*dt             # dt를 곱해줌으로써, 프레임 수와 관계없이 속도를 일정하게 함
    ...
    enemy_rect = enemy.get_rect()  # 적 객체 생성
    enemy_rect.left = enemy_x_pos  # 적의 실제 위치 부여
